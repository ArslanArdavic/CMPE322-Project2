...
void *find_min_max_sorted(void *param);
void *find_range_mode(void *param);
void *find_median_sum(void *param);
void *find_arithmetic__harmonic_mean(void *param);
void *find_standard_deviation_interquartile_range(void *param);
...
int main(int argc, char** argv){
	...
	pthread_create(&tid_1, 0, find_min_max_sorted, &N);
    pthread_create(&tid_2, 0, find_range_mode, &N);
    pthread_create(&tid_3, 0, find_median_sum, &N);
    pthread_create(&tid_4, 0, find_arithmetic__harmonic_mean, &N);
    pthread_create(&tid_5, 0, find_standard_deviation_interquartile_range, &N);    
    ...
    ofstream MyFile("output3.txt");                    // Create, open, write and close a text file
    MyFile << minimum <<endl;
    MyFile << maximum <<endl;
    MyFile << range <<endl;
    MyFile << mode <<endl;
